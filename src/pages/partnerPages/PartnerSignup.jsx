  ...
  const onSubmit = async () => {
    try {
      ...
      if (res?.status === 201) {
        ...
        navigate("/partner/otp", { state: { partnerEmail: partner.email, otpId: otpId,partnerId:partner._id } });
      }
    } catch (error) {
      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row w-10/12 lg:w-8/12 bg-white rounded-xl mx-auto shadow-lg overflow-hidden">
          <div
            ...
            style={{ backgroundImage: "url('/images/car3.jpg')" }}
          >
          ...
          <div className="w-full lg:w-1/2 py-16 px-12">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-3">
                <p>Already have an account? <Link to="/partner/login" className="text-purple-500">Login</Link></p>
              </div>
            </form>
          </div>
        </div>
