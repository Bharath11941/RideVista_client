...
import { partnerForgetPassword } from "../../api/partnerApi";
import { useState } from "react";
import Loading from "../../components/loading/Loading";

const PartnerForgetPass = () => {
  ...
  const onSubmit = async () => {
    try {
      setLoading(true);
      const res = await partnerForgetPassword(values.email);
      if (res.status === 200) {
...
export default PartnerForgetPass;
