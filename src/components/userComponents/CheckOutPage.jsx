...
const CheckOutPage = () => {
  ...
  return (
    <>
      <UserNavbar />
      <div className=" container mx-auto mt-10 mb-52 dark:border-gray-700 shadow border border-gray-200">
          ...
          <div className="bg-white shadow-md rounded-lg p-5">
            ...
            <div className="text-gray-700">
              <p>
                ...
                Eligendi possimus cumque atque architecto, dolorum nisi iusto ab
                aliquid voluptate deleniti nulla modi magni, doloremque tempora
                expedita maxime aliquam earum ratione assumenda. Placeat a rerum
                labore, accusamus quaerat quia neque blanditiis aut, vero,
                possimus obcaecati soluta dolore recusandae. Laudantium itaque,
                sequi eum natus obcaecati veritatis aliquam animi quam quidem,
                corrupti culpa rerum aspernatur mollitia, fuga quia!
              </p>
            </div>
          </div>
        </div>
