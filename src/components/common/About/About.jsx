...
const About = () => {
  return (
    <>
      <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:pb-12 md:pt-8 md:px-6 py-9 px-4">
        <div className="flex flex-col lg:flex-row justify-between gap-8">
          <div className="w-full lg:w-5/12 flex flex-col justify-center">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 ">
              At RideVista, we redefine the way you travel. As a premier car
              rental platform, we are dedicated to providing a seamless and
              enjoyable experience for every journey. From well-maintained
