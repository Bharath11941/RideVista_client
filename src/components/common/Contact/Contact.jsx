...
const Contact = () => {
  return (
    <section className="relative mx-auto container z-10 overflow-hidden bg-white py-20 dark:bg-dark lg:pt-[70px] lg:pb-[120px]">
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-body-color dark:text-dark-6">
                    Parappanangadi,Malappuram 676303. Kerala
                  </p>
                </div>
              </div>
