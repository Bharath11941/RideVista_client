                  ...
                  <td className="px-6 py-4">
                    ...
                    <div
                      ...
                      className={`fixed top-0 left-0 right-0 bottom-0 z-50 flex items-center justify-center p-4 overflow-x-hidden overflow-y-auto md:inset-0 max-h-full ${
                        activeModal === partner._id ? '' : 'hidden'
                      }`}
                    >
                          ...
                          <div className="p-6 text-center">
                            ...
                            {partner.isBlocked ? (
                              <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                Are you sure you want to Unblock this {partner.name}?
                              </h3>
                            ) : (
                              <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                Are you sure you want to Block this {partner.name}?
                              </h3>
                            )}
                            <button
                              data-modal-hide={`popup-modal-${partner._id}`}
                              type="button"
                              onClick={() => blockUnblockPartner(partner._id, partner.isBlocked)}
